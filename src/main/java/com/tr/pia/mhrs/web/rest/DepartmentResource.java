...
/**
 * REST controller for managing {@link com.tr.pia.mhrs.domain.Department}.
 */
@RestController
@RequestMapping("/api")
public class DepartmentResource {
    ...
    public ResponseEntity<List<DepartmentDTO>>getDepartment(@PathVariable Long id) {
        log.debug("REST request to get Department : {}", id);
        List<DepartmentDTO> departmentDTO = departmentService.findOne(id);
