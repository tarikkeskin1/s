...
class DoctorResourceIT {
    ...
    public static Doctor createEntity(EntityManager em) {
        Doctor doctor = new Doctor().title(DEFAULT_TITLE).name(DEFAULT_NAME).lastName(DEFAULT_LAST_NAME);
        return doctor;
    }
    ...
    public static Doctor createUpdatedEntity(EntityManager em) {
        Doctor doctor = new Doctor().title(UPDATED_TITLE).name(UPDATED_NAME).lastName(UPDATED_LAST_NAME);
        return doctor;
    }
    ...
    void putNewDoctor() throws Exception {
        ...
        updatedDoctor.title(UPDATED_TITLE).name(UPDATED_NAME).lastName(UPDATED_LAST_NAME);
    ...
    void partialUpdateDoctorWithPatch() throws Exception {
        ...
        partialUpdatedDoctor.title(UPDATED_TITLE).name(UPDATED_NAME);
    ...
    void fullUpdateDoctorWithPatch() throws Exception {
        ...
        partialUpdatedDoctor.title(UPDATED_TITLE).name(UPDATED_NAME).lastName(UPDATED_LAST_NAME);
